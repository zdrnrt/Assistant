...
function dataInfoChartInDraw() {
	...
	const labels = [ '1.2', '2.2', '3.2', '4.2', '5.2', '6.2', '7.2', '8.2', '9.2', '10.2', '11.2', '12.2', '13.2', '14.2', '15.2', '16.2', '17.2', '18.2', '19.2', '20.2', '21.2', '22.2', '23.2', ];
	const datasets = [
		{
			label: 'Olap',
			data: [ 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 40, 96, 96, 96, 96, 96, ],
		},
		{
			label: 'АЗ',
			data: [ 98, 98, 80, 98, 98, 98, 98, 70, 98, 98, 98, 98, 98, 98, 98, 98, 98, 40, 98, 98, 98, 98, 98, ],
		},
		{
			label: 'Прогноз',
			data: [ 97, 97, 97, 97, 97, 50, 97, 97, 97, 97, 97, 97, 97, 97, 97, 97, 97, 40, 97, 97, 97, 97, 97, ],
		},
	];
