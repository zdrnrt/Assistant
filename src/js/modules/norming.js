...
function normingInit() {
	normingInitModal();
	normingChartDraw();
	document.getElementById('start').addEventListener('click', normingApply);
	document
...
function normingInitModal() {
	...
	document
		...
		.addEventListener('click', normingModalOpen);
	window.modalList = {
...
function normingChartDraw(value = 'normaRc') {
	...
	const chartTitle = {
		...
		normaOosTt: 'Норма OOS ТТ',
		normaUs: 'Норма УС поставщик',
		...
		normaRc: [
			{
				label: 'Рег',
				data: [
					2_508_686, 2_512_248, 2_506_506, 2_544_459, 2_510_838,
					2_490_456, 2_479_778, 2_545_123, 2_452_187, 2_533_371,
					2_575_870,
				],
				stack: 'group',
				order: 0,
			},
			{
				label: 'Овер',
				data: [
					616_890, 607_802, 626_627, 625_687, 607_461, 622_614,
					609_781, 615_755, 613_047, 622_960, 623_194,
				],
				stack: 'group',
				order: 0,
			},
			...
			},
			{
				label: 'Вывод',
				data: [
					370_134, 324_161, 417_751, 375_412, 323_979, 415_076,
					365_869, 328_403, 408_698, 373_776, 332_370,
				],
				stack: 'group',
				order: 0,
			},
			{
				label: 'Итого, факт',
				data: [
					4_112_600, 4_052_013, 4_177_510, 4_171_244, 4_049_738,
					4_150_760, 4_065_209, 4_105_036, 4_086_978, 4_153_067,
					4_154_629,
				],
				stack: 'group',
				order: 0,
			},
			{
				label: 'Итого, план',
				data: [
					3_701_340, 3_646_812, 3_759_759, 3_754_120, 3_644_764,
					3_735_684, 3_658_688, 3_694_533, 3_678_280, 3_737_761,
					3_739_166,
				],
				type: 'line',
				order: 0,
